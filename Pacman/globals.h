...
extern float GHOST_BLINK_ON_DURATION;
extern float GHOST_BLINK_OFF_DURATION;
extern float GHOST_BLINK_BEFORE_FRIGHTEN_END;

extern int RED_GHOST_DOT_TOLERANCE;
extern float RED_GHOSt_SPEED_UPGRADE;
extern int ORANGE_GHOST_TO_AVATAR_PROXIMITY_TOLERANCE;
